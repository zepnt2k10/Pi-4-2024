...
\AddToShipoutPicture*{\put(78,493){\includegraphics[scale=1]{../tieudehihi.pdf}}}  
\centering
\endgroup
\vspace*{215pt} 

\begin{multicols}{2}
	$\pmb{1.}$ \textbf{Vẽ mê cung}
	\vskip 0.1cm
	\textbf{Cách} $\pmb{1:}$
	\vskip 0.1cm
	...
	\vskip 0.1cm
	Đã đến lúc tạo ra con đường của mê cung! Chúng ta sẽ tạo lối vào bằng cách xóa một trong những hình vuông được tô bóng mờ nhẹ để tạo một con đường quanh co dẫn đến lối ra như hình minh họa bên dưới.
	\begin{figure}[H]
		\vspace*{-5pt}
		\centering
		\captionsetup{labelformat= empty, justification=centering}
	...
	\vskip 0.1cm
	\url{https://www.artfulmaths.com/mathematical-art-lessons.html}
\end{multicols}
%\newpage
%\begingroup
...
%	\vskip 0.1cm
%	\textbf{\color{toancuabi}Bài $\pmb1$.} Tìm một số có $3$ chữ số mà khi tăng chữ số hàng trăm lên $3$ đơn vị, chữ số hàng chục lên $2$ đơn vị và chữ số hàng đơn vị lên $1$ đơn vị thì ta nhận được số mới gấp $4$ lần số ban đầu.
%	\vskip 0.1cm
%	\textbf{\color{toancuabi}Bài $\pmb2$.} Trên bảng có viết số $798798798798$. Bạn cần xóa đi một hoặc vài chữ số để kết quả nhận được là một số chia hết cho $9$. Hỏi số lớn nhất mà bạn có thể nhận được là bao nhiêu?
%	\vskip 0.1cm
%	\textbf{\color{toancuabi}Bài $\pmb3$.} Năm học $2022-2023$ là một năm học đặc biệt: không thể đổi chỗ các chữ số của số $2022$ để có một số nhỏ hơn $2022$ và số $2023$ cũng như vậy. (Các số không được bắt đầu bằng chữ số $0$). Hỏi năm học nào gần nhất trước đó cũng đặc biệt như vậy?
%	\vskip 0.1cm
%	\textbf{\color{toancuabi}Bài $\pmb4$.} Hãy đưa ra ví dụ $5$ số hữu tỷ phân biệt nằm giữa $\dfrac{1}{2022}$ và $\dfrac{1}{2023}.$
%	\vskip 0.1cm
%	\textbf{\color{toancuabi}Bài $\pmb5$.} Có bao nhiêu số có $3$ chữ số khác nhau, chia hết cho $11$, được tạo thành từ các chữ số $1,3,5,7,9$?
%	\vskip 0.1cm
%	\textbf{\color{toancuabi}Bài $\pmb6$.} Tìm số tự nhiên $n$  nhỏ nhất sao cho $(n + 1)( n + 2)( n + 3)( n + 4)$ chia hết cho $1000$.
%	\vskip 0.1cm
%	\textbf{\color{toancuabi}Bài $\pmb7$.} Tom viết tất cả các số tự nhiên sao cho tích các chữ số của mỗi số bằng $2016$. Jerry chọn số nhỏ nhất trong chúng. Hỏi Jerry đã chọn số nào?
%	\vskip 0.1cm
%	\textbf{\color{toancuabi}Bài $\pmb8$.} Trong một giải đấu thể dục dụng cụ, mỗi vận động viên được hội đồng giám khảo gồm $7$ người chấm điểm. Mỗi giám khảo cho điểm là một số tự nhiên từ $1$ đến $10$. Sau đó, theo quy định, trong số các điểm mà $7$ giám khảo chấm thì một điểm cao nhất và một điểm thấp nhất sẽ bị loại bỏ (nếu có nhiều điểm cao nhất hoặc thấp nhất bằng nhau thì chỉ loại bỏ một trong số đó) và điểm số chính thức của vận động viên là tổng của $5$ điểm còn lại. Sau một màn trình diễn, một vận động viên được $7$ giám khảo cho tổng số điểm bằng $37$. Hỏi điểm số chính thức của vận động viên đó cao nhất có thể bằng bao nhiêu?
%	\vskip 0.1cm
%	\textbf{\color{toancuabi}Bài $\pmb{9}$.} Nêu một cách điền các số $1$ và $-1$ vào các ô của một bảng $5\times 6$, mỗi ô một số, sao cho nếu lấy tổng của các số trên các hàng và các cột của bảng thì ta nhận được $11$ số khác nhau.
%	\vskip 0.1cm
%	\textbf{\color{toancuabi}Bài $\pmb{10}$.} Trên một hòn đảo nhỏ có $40$ cư dân gồm hai loại người: người Dối trá, luôn luôn nói dối và người Khôn ngoan, khi thì nói thật lúc lại nói dối. Một hôm tất cả các cư dân ngồi họp quanh một bàn tròn và mỗi người đều nói ``Ngồi sát bên cạnh tôi là một người Dối trá và một người Khôn ngoan". Biết rằng lần đó có đúng $3$ người Khôn ngoan nói dối. Hỏi trên đảo có tất cả bao nhiêu người Dối trá.
%	\vskip 0.1cm
%	\textbf{\color{toancuabi}Đáp án}
%	\vskip 0.1cm
%	\textbf{\color{toancuabi}Bài $\pmb{1}$.} $107$.
%	\vskip 0.05cm
%	\textbf{\color{toancuabi}Bài $\pmb{2}$.} $9879879879$.
%	\vskip 0.1cm
%	\textbf{\color{toancuabi}Bài $\pmb{3}$.} $2008-2009$.
%	\vskip 0.1cm
%	\textbf{\color{toancuabi}Bài $\pmb{4}$.} Bài toán có nhiều đáp án, một đáp án mẫu là: $\dfrac{10}{20221}; \dfrac{10}{20222}; \dfrac{10}{20223}; \dfrac{10}{20224}; \dfrac{10}{20225}.$
%	\vskip 0.1cm
%	\textbf{\color{toancuabi}Bài $\pmb{5}$.} $8$.
%	\vskip 0.1cm
%	\textbf{\color{toancuabi}Bài $\pmb{6}$.} $121$.
%	\vskip 0.1cm
%	\textbf{\color{toancuabi}Bài $\pmb{7}$.} $4789$.
%	\vskip 0.1cm
%	\textbf{\color{toancuabi}Bài $\pmb{8}$.} \textit{Lời giải.}
...
%	Đáp số $30$.
%	\vskip 0.1cm
%	\textbf{\color{toancuabi}Bài $\pmb{9}$.} \textit{Lời giải.} Một ví dụ
%	\begin{center}
%		\begin{tikzpicture}
%			\draw (0,0) grid (6, 5);
%			\foreach \y in {0,...,4} \node at (0.5,\y+0.5){$-1$};
...
%	\vskip 0.2cm
%	\PIbox{
%	\textbf{\color{toancuabi}\color{toancuabi}\color{toancuabi}Example $\pmb6$.}
...
%	\vskip 0.2cm
%	\PIbox{\textbf{\color{toancuabi}\color{toancuabi}\color{toancuabi}Example $\pmb7$.}
...
%	\vskip 0.2cm
%	\PIbox{\textbf{\color{toancuabi}\color{toancuabi}\color{toancuabi}Example $\pmb8$.}
...
%	\vskip 0.2cm
%	\PIbox{\textbf{\color{toancuabi}\color{toancuabi}\color{toancuabi}Example $\pmb9$.}
...
%	\vskip 0.2cm
%	\PIbox{\textbf{\color{toancuabi}\color{toancuabi}\color{toancuabi}Example $\pmb10$.}
